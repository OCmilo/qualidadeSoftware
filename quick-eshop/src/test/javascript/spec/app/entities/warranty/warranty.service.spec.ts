...
describe('Service Tests', () => {
  describe('Warranty Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Warranty(0, 'AAAAAAA', 0);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should not create a Warranty', async () => {
      ...
      it('should not update a Warranty', async () => {
      ...
      it('should not partial update a Warranty', async () => {
      ...
      it('should not return a list of Warranty', async () => {
        axiosStub.get.rejects(error);
      ...
      it('should not delete a Warranty', async () => {
