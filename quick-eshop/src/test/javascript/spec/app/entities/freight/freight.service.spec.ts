...
describe('Service Tests', () => {
  describe('Freight Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Freight(0, 'AAAAAAA', 0);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should not create a Freight', async () => {
      ...
      it('should not update a Freight', async () => {
      ...
      it('should partial update a Freight', async () => {
        const patchObject = Object.assign({}, new Freight());
      ...
      it('should not partial update a Freight', async () => {
      ...
      it('should not return a list of Freight', async () => {
        axiosStub.get.rejects(error);
      ...
      it('should not delete a Freight', async () => {
