    ...
    <div class="col-10">
      ...
      <div v-if="taskContext.taskInstance">
        ...
        <router-link
          ...
          :to="`/process-definition/PurchaseProcess/task/ProceedCheckout/${taskContext.taskInstance.id}/execute`"
          tag="button"
...
<script lang="ts" src="./proceed-checkout-details.component.ts"></script>
