    ...
    <div class="col-10">
      ...
      <div v-if="taskContext.taskInstance">
        <akip-show-task-instance :taskInstance="taskContext.taskInstance">
          <template v-slot:body>
            ...
            <div class="form-group">
              ...
              <input
                v-if="taskContext.purchaseProcess.purchase.warranty"
                readonly
                type="text"
                class="form-control"
                name="warranty"
        ...
        <router-link
          ...
          :to="`/process-definition/PurchaseProcess/task/AddWarranty/${taskContext.taskInstance.id}/execute`"
          tag="button"
...
<script lang="ts" src="./add-warranty-details.component.ts"></script>
