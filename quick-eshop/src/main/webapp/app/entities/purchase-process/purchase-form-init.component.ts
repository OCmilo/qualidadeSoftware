...
export default class PurchaseFormInitComponent extends Vue {
  ...
  public save(): void {
    ...
    this.purchaseProcessService()
      ...
      .then(param => {
        this.isSaving = false;
        this.$router.go(-1);
        const message = this.$t('quickeshopApp.purchaseForm.created', { param: param.id });
